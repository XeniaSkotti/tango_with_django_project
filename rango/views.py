...
def user_login(request):
    #if the rquest is a HTTP POST, try to pull out the relevant information.
    if request.method == "POST":
        #gather the username and password provided by the user.
        #this information is obtained from the login form.
        #None if the value does not exist, while request.POST['<variable>']
        #will raise a KeyError excpetion.
...
def visitor_cookie_handler(request):
    ...
    visits = int(get_server_side_cookie(request, 'visitis', '1'))
